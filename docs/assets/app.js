...
const i18nData = {
  ar: {
    ...
    hero_pill: "إصدار رسمي معتمد • Setup.exe • 4.46 MB",
    ...
    detail_2_desc: "تفريغ المساحات المهدرة في الذاكرة بضغطة واحدة مع حماية أكثر من 15 خدمة أساسية للنظام.",
  ...
  en: {
    ...
    hero_pill: "Official Windows Release • Setup.exe • 4.46 MB",
    ...
    detail_2_desc: "Safely flush inactive working sets with built-in protection for 15+ essential Windows NT services.",
